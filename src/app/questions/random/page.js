    ...
    <div className="page-background">
      <div style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <div className="quote-container">
          <p>
            "어렸을 때부터 저는 알고 싶었습니다. 우리가 태어난 이유. 고통과 사랑이 존재하는 이유. 이러한 질문은 수천 년 동안 문학이 던져온 질문이며, 오늘날에도 계속되고 있습니다. 우리가 이 세상에 잠시 머무는 것의 의미는 무엇일까요? 무슨 일이 있어도 인간으로 남는다는 것은 얼마나 어려운 일일까요? 가장 어두운 밤, 우리가 무엇으로 이루어져 있는지 묻는 언어, 이 지구에 사는 사람들과 생명체의 일인칭 시점으로 상상하는 언어, 우리를 서로 연결해주는 언어가 있습니다. 이러한 언어를 다루는 문학은 필연적으로 일종의 체온을 지니고 있습니다. 필연적으로 문학을 읽고 쓰는 작업은 생명을 파괴하는 모든 행위에 반대되는 위치에 서 있습니다."
          </p>

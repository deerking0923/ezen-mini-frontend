...
export const spiritsData = [
    ...
    levels: [
      ...
      {
        level: 4,
        leftNodes: [{ id: "s1_l4_n1", type: "normal", cost: 36 },
      ...
      {
        level: 1,
        leftNodes: [{ id: "s1_l1_n1", type: "normal", cost: 0 },
  ...
  },
{
    ...
    levels: [
      ...
      {
        level: 4,
        leftNodes: [{ id: "s2_l4_n1", type: "normal", cost: 12 },
            { id: "s2_l4_n2", type: "normal", cost: 0 }
        ],
        rightNodes: [{ id: "s2_l4_s1", type: "season", cost: 0 }, { id: "s2_l4_s2", type: "season", cost: 0 }],
      },
      {
        level: 3,
        leftNodes: [
        ...
        rightNodes: [{ id: "s2_l3_s1", type: "season", cost: 0 }] // 기존에 s2로 되어 있던 것은 그대로 s2로 유지했습니다.
      },
      {
        level: 2,
        leftNodes: [
      ...
      {
        level: 1,
        leftNodes: [{ id: "s2_l1_n1", type: "normal", cost: 0 },
...
      {
        level: 4,
        leftNodes: [{ id: "s3_l4_n1", type: "normal", cost: 12 },
            { id: "s3_l4_n2", type: "normal", cost: 0 }
        ],
        rightNodes: [{ id: "s3_l4_s1", type: "season", cost: 0 }, { id: "s3_l4_s2", type: "season", cost: 0 }],
      },
      {
        level: 3,
        leftNodes: [
          { id: "s3_l3_n1", type: "normal", cost: 24 },
          { id: "s3_l3_n2", type: "normal", cost: 6 }
        ],
...
        level: 2,
        leftNodes: [
          { id: "s3_l2_n1", type: "normal", cost: 23 },
          { id: "s3_l2_n2", type: "normal", cost: 4 }
        ],
        rightNodes: [{ id: "s3_l2_s1", type: "season", cost: 0 }]
      },
      {
        level: 1,
        leftNodes: [{ id: "s3_l1_n1", type: "normal", cost: 0 },
...
      {
        level: 4,
        leftNodes: [{ id: "s4_l4_n1", type: "normal", cost: 12 },
            { id: "s4_l4_n2", type: "normal", cost: 0 }
        ],
        rightNodes: [{ id: "s4_l4_s1", type: "season", cost: 0 }, { id: "s4_l4_s2", type: "season", cost: 0 }],
      },
      {
        level: 3,
        leftNodes: [
          { id: "s4_l3_n1", type: "normal", cost: 24 },
          { id: "s4_l3_n2", type: "normal", cost: 6 }
        ],
...
        level: 2,
        leftNodes: [
          { id: "s4_l2_n1", type: "normal", cost: 23 },
          { id: "s4_l2_n2", type: "normal", cost: 4 }
        ],
        rightNodes: [{ id: "s4_l2_s1", type: "season", cost: 0 }]
      },
      {
        level: 1,
        leftNodes: [{ id: "s4_l1_n1", type: "normal", cost: 0 },
...
      {
        level: 4,
        leftNodes: [{ id: "s5_l4_n1", type: "normal", cost: 12 },
            { id: "s5_l4_n2", type: "normal", cost: 0 }
        ],
        rightNodes: [{ id: "s5_l4_s1", type: "season", cost: 0 }, { id: "s5_l4_s2", type: "season", cost: 0 }],
      },
      {
        level: 3,
        leftNodes: [
          { id: "s5_l3_n1", type: "normal", cost: 24 },
          { id: "s5_l3_n2", type: "normal", cost: 6 }
        ],
...
        level: 2,
        leftNodes: [
          { id: "s5_l2_n1", type: "normal", cost: 23 },
          { id: "s5_l2_n2", type: "normal", cost: 4 }
        ],
        rightNodes: [{ id: "s5_l2_s1", type: "season", cost: 0 }]
      },
      {
        level: 1,
        leftNodes: [{ id: "s5_l1_n1", type: "normal", cost: 0 },
